...
5. **EQ**: резать 3–6 кГц при необходимости ([шип](../../terminy/ship.md)); поднимать 1–2 кГц для читаемости.
...
| Ambient Pad | [05-ambient-pad.md](./05-ambient-pad.md) | Пад / эмбиент (узнаваемая мандолина) |
| Bright Lead | [06-bright-lead.md](./06-bright-lead.md) | Яркий лид на edge-of-breakup, контроль ВЧ |
| Synth Bed | [07-synth-bed.md](./07-synth-bed.md) | Синтезаторная фактура / фон в миксе |
| Call & Response | [08-call-response.md](./08-call-response.md) | Соло вопрос–ответ с перегруженной гитарой |
| Reggae Skank | [09-reggae-skank.md](./09-reggae-skank.md) | Регги-ритм (offbeat); гитара фоном |
